  ...
  return (
    <Card className="supervisor-chat-card">
      <CardHeader
        ...
        action={
          <IconButton className="mobile-only" onClick={() => setDrawerOpen(true)}>
      ...
      <CardContent className="supervisor-chat-body">
                ...
                >
                  ...
                  <div className="agent-name-wrapper">
                    ...
                    {unreadCounts[agent.id] > 0 && (
                      <span className="unread-badge">{unreadCounts[agent.id]}</span>
                    )}
                  </div>
                </div>
              ))}
        ...
        <Drawer anchor="left" open={drawerOpen} onClose={() => setDrawerOpen(false)}>
          <div className="agent-list mobile-pane">
            <h4 className="agent-title">Agents</h4>
            <div className="agent-scroll">
              {agents.map((agent) => (
                <div
        ...
        <div className="supervisor-chat-pane">
            ...
            {messages
              ...
              .map((msg, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`chat-bubble ${isSupervisor ? "supervisor" : "agent"}`}
                  >
                    {msg.message}
          ...
          <div className="chat-input-wrapper">
            ...
            />
            <Button variant="contained" onClick={sendReply} className="send-button">
              Send
            </Button>
          </div>
        </div>
